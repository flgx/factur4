...
<div class="row">
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            {!! Form::select('setting_merchant[PayPalExpress][testMode]', [0=>trans('fi.no'),1=>trans('fi.yes')], $merchant['PayPalExpress']['testMode'], ['class' => 'form-control']) !!}
        </div>
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="col-md-4">
        <div class="form-group">
            ...
            {!! Form::text('setting_merchant[PayPalExpress][paymentButtonText]', $merchant['PayPalExpress']['paymentButtonText'], ['class' => 'form-control']) !!}
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    {!! Form::select('setting_merchant[Stripe][requireBillingName]', $merchantCcOptions, $merchant['Stripe']['requireBillingName'], ['class' => 'form-control']) !!}
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <label>{{ trans('fi.billing_address') }}: </label>
                    {!! Form::select('setting_merchant[Stripe][requireBillingAddress]', $merchantCcOptions, $merchant['Stripe']['requireBillingAddress'], ['class' => 'form-control']) !!}
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <label>{{ trans('fi.billing_city') }}: </label>
                    {!! Form::select('setting_merchant[Stripe][requireBillingCity]', $merchantCcOptions, $merchant['Stripe']['requireBillingCity'], ['class' => 'form-control']) !!}
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <label>{{ trans('fi.billing_state') }}: </label>
                    {!! Form::select('setting_merchant[Stripe][requireBillingState]', $merchantCcOptions, $merchant['Stripe']['requireBillingState'], ['class' => 'form-control']) !!}
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <label>{{ trans('fi.billing_zip') }}: </label>
                    {!! Form::select('setting_merchant[Stripe][requireBillingZip]', $merchantCcOptions, $merchant['Stripe']['requireBillingZip'], ['class' => 'form-control']) !!}
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-md-4">
        <div class="form-group">
            <label>{{ trans('fi.payment_button_text') }}: </label>
            {!! Form::text('setting_merchant[Stripe][paymentButtonText]', $merchant['Stripe']['paymentButtonText'], ['class' => 'form-control']) !!}
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-4">
        <div class="form-group">
            <label>{{ trans('fi.payment_button_text') }}: </label>
            {!! Form::text('setting_merchant[Mollie][paymentButtonText]', $merchant['Mollie']['paymentButtonText'], ['class' => 'form-control']) !!}
        </div>
    </div>
</div>