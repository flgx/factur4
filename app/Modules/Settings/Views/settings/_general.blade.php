                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::select('setting_amountDecimals', $amountDecimalOptions, config('fi.amountDecimals'), ['class' => 'form-control']) !!}
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::select('setting_roundTaxDecimals', $roundTaxDecimalOptions, config('fi.roundTaxDecimals'), ['class' => 'form-control']) !!}
                        </div>
                    </div>
                </div>
            </div>
