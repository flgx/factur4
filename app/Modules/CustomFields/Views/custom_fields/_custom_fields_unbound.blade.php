...
@foreach ($customFields as $customField)
    <div class="form-group">
        ...
        @else
            {!! call_user_func_array('Form::' . $customField->field_type, ['custom[' . $customField->column_name . ']', (isset($object->custom->{$customField->column_name}) ? $object->custom->{$customField->column_name} : null), ['class' => 'custom-form-field form-control', 'data-field-name' => $customField->column_name]]) !!}
        @endif
    </div>
@endforeach