...
class MerchantController extends Controller
{
    ...
    public function recordSuccessTransaction($response, $invoice)
    {
        ...
        $payment = $this->paymentRepository->create(['invoice_id' => $invoice->id, 'payment_method_id' => (config('fi.onlinePaymentMethod') ?: 0), 'amount' => $requestParameters['amount'], 'paid_at' => date('Y-m-d'), 'note' => ''], false);
