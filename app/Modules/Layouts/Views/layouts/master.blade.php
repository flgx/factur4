    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="{{ route('delegacions.index') }}">
                        <i class="fa fa-bank"></i> <span>{{ trans('fi.delegacions') }}</span>
                    </a>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ route('reports.clientStatement') }}"><i
                                        class="fa fa-caret-right"></i> {{ trans('fi.client_statement') }}</a>
                        </li>
                        ...
                        <li><a href="{{ route('reports.paymentsCollected') }}"><i
                                        class="fa fa-caret-right"></i> {{ trans('fi.payments_collected') }}</a>
                        </li>
                        ...
                        <li><a href="{{ route('reports.revenueByClient') }}"><i
                                        class="fa fa-caret-right"></i> {{ trans('fi.revenue_by_client') }}</a>
                        </li>
