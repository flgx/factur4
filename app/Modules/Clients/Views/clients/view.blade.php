                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table class="table table-striped">
                                            <tr>
                                                <td class="col-md-2">Codi client:</td>
                                                <td class="col-md-10">{{{ $client->id }}}</td>
                                            </tr>
                                            <tr>
                                                <td class="col-md-2">DNI</td>
                                                <td class="col-md-10">{{{ $client->dni }}}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="col-md-2">IBAN</td>
                                                <td class="col-md-10">{{{ $client->iban }}}</td>
                                            </tr>
                                            <tr>
                                                <td class="col-md-2">BIC</td>
                                                <td class="col-md-10">{{{ $client->bic }}}</td>
                                            </tr>
