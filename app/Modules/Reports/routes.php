...
Route::group(['middleware' => 'auth.admin', 'namespace' => 'FI\Modules\Reports\Controllers'], function ()
{
    ...
    Route::get('reports/profit_loss', ['uses' => 'ProfitLossReportController@index', 'as' => 'reports.profitLoss']);
    Route::post('reports/profit_loss/validate', ['uses' => 'ProfitLossReportController@validate', 'as' => 'reports.profitLoss.validate']);
    Route::get('reports/profit_loss/html', ['uses' => 'ProfitLossReportController@html', 'as' => 'reports.profitLoss.html']);
    Route::get('reports/profit_loss/pdf', ['uses' => 'ProfitLossReportController@pdf', 'as' => 'reports.profitLoss.pdf']);
});