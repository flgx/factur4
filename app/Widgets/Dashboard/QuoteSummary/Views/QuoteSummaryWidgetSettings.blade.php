...
<div class="form-group">
    ...
    {!! Form::select('setting_widgetQuoteSummaryDashboardTotals', $dashboardTotalOptions, config('fi.widgetQuoteSummaryDashboardTotals'), ['class' => 'form-control', 'id' => 'quote-dashboard-total-setting']) !!}
</div>
